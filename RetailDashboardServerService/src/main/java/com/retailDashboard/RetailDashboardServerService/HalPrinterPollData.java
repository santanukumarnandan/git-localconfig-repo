...
@Entity
@Table(name = "HAL_RD_PRINTER_POLLING_DATA")
public class HalPrinterPollData {
	...
	public HalPrinterPollData() {
		super();
	}



	public HalPrinterPollData(Long recordNumber, String stroreNumber, String storeIpAddress, String pollingDate,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HalPrinterPollData other = (HalPrinterPollData) obj;
		if (dateUp == null) {
