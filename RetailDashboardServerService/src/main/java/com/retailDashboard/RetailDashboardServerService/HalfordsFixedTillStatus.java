...
@Repository
public class HalfordsFixedTillStatus {
	...
	public List<FixedTillBean> getFixedTillStatus(List<HalFixedTillMaster> fixedTillMaster, List<Long> storeNumbers)
		...
		for (HalFixedTillMaster halFixedTillMaster : fixedTillMaster) {
			fixedTillAttributesparentMap.put(halFixedTillMaster.getStoreNumber().toString(),
					new FixedTillBean(halFixedTillMaster.getStoreIpAddress(),
							halFixedTillMaster.getStoreNumber().toString(), halFixedTillMaster.getDiscoveryDate(),
		...
		for (Entry<String, FixedTillBean> mapElement : fixedTillAttributesparentMap.entrySet()) {
			...
			if (geek1.isReachable(140)) {
				...
				fixedTillAttributesFirstMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
		...
		for (Entry<String, FixedTillBean> mapElement : fixedTillAttributesSecondtMap.entrySet()) {
			for (Entry<String, FixedTillBean> mapElement1 : fixedTillAttributesFirstMap.entrySet()) {
				if (mapElement.getValue().getFixedTillStoreNumber().equals(mapElement1.getValue().getFixedTillStoreNumber())) {
					...
					hhtAttributesThirdtMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
							fixedTillDetails.getFixedTillStoreNumber().toString(),
							fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
							fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
							fixedTillDetails.getFixedTillHostName()));
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesThirdtMap.entrySet()) {
			...
			if (geek1.isReachable(140)) {
				...
				hhtAttributesFourthtMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
						fixedTillDetails.getFixedTillStoreNumber().toString(),
						fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
						fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
						fixedTillDetails.getFixedTillHostName()));
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesThirdtMap.entrySet()) {
			for (Entry<String, FixedTillBean> mapElement1 : hhtAttributesFourthtMap.entrySet()) {
				if (mapElement.getValue().getFixedTillStoreNumber().equals(mapElement1.getValue().getFixedTillStoreNumber())) {
					...
					// storeDetails.getStoreNumber(),storeDetails.getTillIpAddress(), "Host is
					// unreacheable", storeDetails.getStoreAddress()));
					hhtAttributesFifthtMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
							fixedTillDetails.getFixedTillStoreNumber().toString(),
							fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
							fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
							fixedTillDetails.getFixedTillHostName()));
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesFifthtMap.entrySet()) {
			...
			if (geek1.isReachable(140)) {
				...
				hhtAttributesSixthtMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
						fixedTillDetails.getFixedTillStoreNumber().toString(),
						fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
						fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
						fixedTillDetails.getFixedTillHostName()));
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesFifthtMap.entrySet()) {
			for (Entry<String, FixedTillBean> mapElement1 : hhtAttributesSixthtMap.entrySet()) {
				if (mapElement.getValue().getFixedTillStoreNumber().equals(mapElement1.getValue().getFixedTillStoreNumber())) {
					...
					// storeDetails.getStoreNumber(),storeDetails.getTillIpAddress(), "Host is
					// unreacheable", storeDetails.getStoreAddress()));
					hhtAttributesSeventhMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
							fixedTillDetails.getFixedTillStoreNumber().toString(),
							fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
							fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
							fixedTillDetails.getFixedTillHostName()));
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesSeventhMap.entrySet()) {
			...
			if (geek1.isReachable(140)) {
				...
				hhtAttributesEightMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
						fixedTillDetails.getFixedTillStoreNumber().toString(),
						fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
						fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
						fixedTillDetails.getFixedTillHostName()));
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesSeventhMap.entrySet()) {
			for (Entry<String, FixedTillBean> mapElement1 : hhtAttributesEightMap.entrySet()) {
				if (mapElement.getValue().getFixedTillStoreNumber().equals(mapElement1.getValue().getFixedTillStoreNumber())) {
					...
					// storeDetails.getStoreNumber(),storeDetails.getTillIpAddress(), "Host is
					// unreacheable", storeDetails.getStoreAddress()));
					hhtAttributesNnthMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
							fixedTillDetails.getFixedTillStoreNumber().toString(),
							fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
							fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
							fixedTillDetails.getFixedTillHostName()));
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesNnthMap.entrySet()) {
			...
			if (geek1.isReachable(140)) {
				...
				hhtAttributesTenthMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
						fixedTillDetails.getFixedTillStoreNumber().toString(),
						fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
						fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
						fixedTillDetails.getFixedTillHostName()));
			...
			for (Entry<String, FixedTillBean> mapElement1 : hhtAttributesTenthMap.entrySet()) {
				if (mapElement.getValue().getFixedTillStoreNumber().equals(mapElement1.getValue().getFixedTillStoreNumber())) {
					...
					hhtAttributesEleventhMap.put(storeNumber,
							new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
									fixedTillDetails.getFixedTillStoreNumber().toString(),
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesEleventhMap.entrySet()) {
			...
			if (geek1.isReachable(140)) {
				...
				hhtAttributesTwelvethMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
						fixedTillDetails.getFixedTillStoreNumber().toString(),
						fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
						fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
						fixedTillDetails.getFixedTillHostName()));
		...
		for (Entry<String, FixedTillBean> mapElement : hhtAttributesThirteenthMap.entrySet()) {
			...
			if (geek1.isReachable(140)) {
				...
				hhtAttributesFourteenthMap.put(storeNumber, new FixedTillBean(fixedTillDetails.getFixedTillIpAddress(),
						fixedTillDetails.getFixedTillStoreNumber().toString(),
						fixedTillDetails.getFixedTillDiscoveryDate(), fixedTillDetails.getFixedTillDiscoveryTime(),
						fixedTillDetails.getFixedTillRecordNumber(), fixedTillDetails.getFixedTillIsActive(),
						fixedTillDetails.getFixedTillHostName()));
