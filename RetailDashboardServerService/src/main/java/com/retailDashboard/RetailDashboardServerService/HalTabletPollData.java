...
@Entity
@Table(name = "HAL_RD_TABLET_POLLING_DATA")
public class HalTabletPollData {
	...
	public HalTabletPollData(Long recordNumber, String stroreNumber, String storeIpAddress, String pollingDate,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HalTabletPollData other = (HalTabletPollData) obj;
		if (dateUp == null) {
