...
public class HalFixedTillPollData {
	...
	public HalFixedTillPollData(String recordNumber, String storeIpAddress, String pollingDate, String pollingTime,
			String pollingNumber, String dateUp, String timeUp, String downSince) {
		super();
